    ...
    <header class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="${pageContext.request.contextPath}/teachers" class="active">Tìm giảng viên</a></li>
            </ul>
            ...
            <aside class="sidebar-filters">
                <div class="filter-card">
                    ...
                    <ul class="subject-list teacher-sidebar">
                        <%
                            String[] subjects = {"Tất cả", "Toán", "Văn", "Anh", "Lý", "Hóa", "Sinh Học", "Lịch Sử", "Địa Lý", "GDCD", "Tin Học"};
                            for (String subject : subjects) {
                        %>
                            <li>
                                <a href="<%= h(teacherFilterUrl(request.getContextPath(), subject, currentTeacherType, searchQuery)) %>"
                                   class="<%= subject.equalsIgnoreCase(currentSubject) ? "active" : "" %>"><%= h(subject.equals("Tất cả") ? "Tất cả môn học" : subject) %></a>
                            </li>
                        <% } %>
                    </ul>
                </div>
        ...
        <div class="footer-card">
            <div class="footer-bottom-bar">
                ...
                <div class="footer-legal-links">
                    ...
                    <a href="${pageContext.request.contextPath}/register.jsp">Đăng ký giảng dạy</a>
                </div>
            </div>
        </div>
    </footer>
