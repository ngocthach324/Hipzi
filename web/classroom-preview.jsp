...
<%
    ...
    ClassroomMaterial material = (ClassroomMaterial) request.getAttribute("material");
    String signedUrl = (String) request.getAttribute("signedUrl");
    String classId = classroom != null ? classroom.getId() : "";
    String title = material != null && material.getTitle() != null ? material.getTitle() : "Tài liệu lớp học";
    ...
    <main class="preview-shell">
        <header class="preview-bar">
            ...
            <div class="preview-actions">
                <a class="preview-btn" href="${pageContext.request.contextPath}/classroom?id=<%= h(classId) %>">Quay lại lớp</a>
                <a class="preview-btn primary" href="${pageContext.request.contextPath}/classroom-file?id=<%= h(material != null ? material.getId() : "") %>">Tải file</a>
            </div>
        </header>
        ...
        <section class="preview-stage">
            ...
            <% } else { %>
                <div class="preview-empty">
                    Định dạng này chưa hỗ trợ xem trước trực tiếp trong trình duyệt. Bạn vẫn có thể tải file về để mở trên thiết bị.
                </div>
            <% } %>
        </section>
    </main>
