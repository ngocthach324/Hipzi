...
<body>
    ...
    <section class="subjects-section">
        <div class="subjects-frame">
            ...
            <div class="subjects-card-shell">
                ...
                <button type="button" class="subject-card subject-card--technology" role="tab" aria-selected="false"
    ...
    <section id="ai-roadmap" class="ai-roadmap-section">
        ...
        <div class="ai-roadmap-action">
            <a class="ai-roadmap-cta" href="${pageContext.request.contextPath}/login">Bắt đầu với HIPZI AI <span aria-hidden="true">›</span></a>
        </div>
    </section>
