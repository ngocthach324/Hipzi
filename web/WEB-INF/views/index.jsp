                                            ...
                                            <div class="dropdown-menu-popup">
                                                <a href="${pageContext.request.contextPath}/profile">
                                                    ...
                                                    <span class="avatar-menu-copy">
                                                        <span class="avatar-menu-title">
                                                            <%= profileMenuLabel %>
                                                        </span>
                                                        <span class="avatar-menu-subtitle">Vai trò: <%= profileRoleLabel
                                                                %></span>
                                                    </span>
                                                </a>
                                                <a href="${pageContext.request.contextPath}/teacher-wallet"
                                                    ...
                                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                                        stroke="currentColor" stroke-width="2.2">
                                                        <path
                                                            d="M20 7H5a2 2 0 0 0 0 4h15v8H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16v4z" />
                                                        <path d="M16 14h.01" />
                                                    </svg>
                                                    <span class="avatar-menu-copy">
                                                ...
                                                <a
                                                    ...
                                                    <span class="avatar-menu-copy">
                                                        ...
                                                        <span class="avatar-menu-subtitle">Lớp học, khóa học và tài
                                                            liệu</span>
                                                    </span>
                                                </a>
