    ...
    <main class="exam-gateway">
        <div class="exam-gateway-inner">
            ...
            <section class="exam-card-grid" aria-label="Các hạng mục thi trong HIPZI">
                <a class="exam-entry-card" href="${pageContext.request.contextPath}/mock-exams" aria-label="Mở hạng mục Thi thử">
                    <div>
                ...
                <a class="exam-entry-card" href="${pageContext.request.contextPath}/hipzi-exams" data-tone="contest" aria-label="Mở hạng mục Kỳ thi HIPZI">
                    <div>
